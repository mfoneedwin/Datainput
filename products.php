...
<html><head>
    <meta charset="utf-8">
    <title> <?php echo "$title | MeiyiWuhan"; ?> </title>
...
<body>
	...
	<!--// END Footer Copyright Bar --><!-- Start Copyright Bar 2 -->
        ...
        <div class="container">
            <div class="col-sm-12">
                <div class="underlined-title">
                    ...
                    <hr>
                    <div class="editContent">
                        <h2><?php if($max==0) echo 'This product is not available for the moment. '; ?></h2>
                    </div>
                </div>
            </div>
        </div>
    </section>
    <!--// END Content Block 3-7 --><!-- Start Content Block 3-8 -->
    
    <!--// END Content Block 3-8 --><!-- Start Shop 1-4 -->
    <section id="shop-1-4" class="content-block-nopad shop-1-4">
			...
			<div id="shop">
				...
				<div class="row">
					...
					<?php 
                            ...
                            echo $product->displayProduct($page, $productPerPage,$product_model->getProductByCategory($category),$max) ;
    	...
    	<ul class="pager">
			    <li class="previous <?php if ($page==0) echo 'disabled'; ?> "><a href="products.php?category=<?php echo $category;?>&page=<?php echo $prev; ?>"><span aria-hidden="true">&larr;</span> Previous</a></li>
			    <li class="next <?php if ($page==$maxPage || $max==0) echo 'disabled'; ?> "><a href="products.php?category=<?php echo $category;?>&page=<?php echo $next; ?>">Next <span aria-hidden="true">&rarr;</span></a></li>
			  </ul>
